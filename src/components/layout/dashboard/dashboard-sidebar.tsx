...
export function DashboardSidebar({ isOpen = true, onClose, className, onToggle, isCollapsed = false }: DashboardSidebarProps) {
  ...
  return (
    <aside className={cn(
      "flex flex-col h-full bg-background shadow-md transition-all duration-300 ease-in-out",
      className
    )}>
      <div className={cn("p-4 flex items-center gap-3", isCollapsed && "px-2 justify-center")}>
      ...
      <div className="p-3 mt-auto">
        ...
        <Button
          variant="ghost"
          className={cn(
            "w-full h-10 mt-3 px-3 flex items-center",
            isCollapsed ? "justify-center" : "justify-start",
            "hover:bg-accent hover:text-accent-foreground"
          )}
          onClick={onToggle}
